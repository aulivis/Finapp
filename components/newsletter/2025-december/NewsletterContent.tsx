...
import NewsletterAudioPlayer from './NewsletterAudioPlayer'
import FontSizeControls from './FontSizeControls'
import InflationInterestChart from './InflationInterestChart'
...
export default function NewsletterContent() {
  ...
  // Calculate base font size with multiplier
  const baseFontSize = parseFloat(typography.fontSize.base)
  const currentFontSize = `${baseFontSize * fontSizeMultiplier}px`

  return (
    <>
      {/* Audio Player and Font Size Controls */}
      <div style={{
        display: 'flex',
      ...
      {/* Newsletter Content Area with dynamic font size */}
      <div style={{
